...
The RTX 4090D evidence supersedes the local-unavailable row for typed batch
integration: the full suite and all four model smokes passed. Per-region Graph
capture proof remains a separate optimization gate in TASK-20260722-012.

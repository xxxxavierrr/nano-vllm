...
Server integration passed for MTP k=2 and zero rejected-prefix replay. The
listed multi-k and goodput matrix remains an optimization experiment in
TASK-20260722-012, not an unrecorded pass in this extraction task.
